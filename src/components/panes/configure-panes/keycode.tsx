...
console.log(generateKeycodeCategories,'||||',maybeFilter,'---',Pane);
...
export const KeycodePane: FC = () => {
  ...
  // 获取键盘数据 大部分都是写死的 可以通过 getKeycodes这函数修改
  ...
  // console.log('KeycodeCategories----',KeycodeCategories);
  // 
  // console.log('selectedCategoryKeycodes-----',selectedCategoryKeycodes);
